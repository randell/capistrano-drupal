Capistrano::Configuration.instance(:must_exist).load do
  ...
  after "deploy:update_code", "drupal:directory_prepare", "drupal:symlink_shared", "drush:site_offline", "drush:updatedb", "drush:site_online", "drush:cache_clear"
  ...
  namespace :drupal do
    ...
    desc "Prepare the site directory"
    task :directory_prepare do
      if !exists?('#{app_path}/sites/default')
        run "mkdir #{app_path}/sites/default"
      end
    end
